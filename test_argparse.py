...
class TestDoubleDashRemoval(ParserTestCase):
    ...
    failures = [
        # 'cmd --foo bar 1 2 3', # why do these work in refactor but not before?
        #'cmd -f1 2 3'
        ]
    successes = [
        ('cmd --foo bar 1 2 3', NS(cmd='cmd', foo='bar', rest=['1', '2', '3'])),
...
class TestNargsRange6(ParserTestCase):
    # a range positional with other variable positional; issue11354
